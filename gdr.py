...
class Static_Obj_Pos(Enum):
    ...
    #Not in use since keeping track of the in game timer using screenshots is very inaccurate
...
#Passes:
#       num_map: The dictionary that contains the pixel additions totals and the value 0-9 which they map to
...
def calc_num_total(num_map, box):
    ...
    if total == 0 and numbers_place == 1:
        ...
        return(total)
#_______________________________________________________________________________________________________________________________
#       Function that calculated the num_id used to identify what number a screenshot represents
#Passes:
